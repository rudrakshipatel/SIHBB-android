...
class LandingScreen extends StatelessWidget {
      ...
      body: SafeArea(
        child: Column(children: [
          Container(
            ...
            child: Text('🪷 ${t('Empowering Artisans · Preserving Traditions · Connecting Markets')}',
          ...
          Expanded(
            child: ListView(padding: const EdgeInsets.fromLTRB(16, 16, 16, 28), children: [
              ...
              RichText(text: TextSpan(children: [
                TextSpan(text: '${t('Bridging Tradition.')}\n', style: serif(size: 30, color: AppColors.green)),
                TextSpan(text: t('Building Tomorrow.'), style: serif(size: 30, color: AppColors.terracotta)),
              ])),
              const SizedBox(height: 10),
              Text(t('Hastakala connects skilled artisans with the right buyers, helping traditional crafts find new markets and lasting impact.'),
              ...
              Center(child: Text(t('Explore Authentic Handmade Crafts'), style: serif(size: 18, color: AppColors.green))),
  ...
  Widget _headerBtn(String label, Color color, VoidCallback onTap) => TextButton(
        ...
        child: Text(t(label), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
      );
        ...
        child: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(t(title), style: TextStyle(color: fg, fontWeight: FontWeight.w700, fontSize: 15)),
              Text(t(sub), style: TextStyle(color: outlined ? AppColors.muted : Colors.white70, fontSize: 11)),
            ]),
...
class _Trust extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 4),
        Text(t(title), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 11.5)),
        Text(t(sub), style: const TextStyle(fontSize: 10, color: AppColors.muted)),
      ]);
}
